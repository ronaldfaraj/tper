...
TPerl_RaidMonitor sub-addon (WORK IN PROGRESS)
----------------------------------------------
Casting Monitor
...
TPerl_RaidAdmin sub-addon (WORK IN PROGRESS)
-------------------------------------------
Raid Admin
...
Frame names:
        ...
        TPerl_Target
        TPerl_TargetTarget
        TPerl_TargetTargetTarget
        TPerl_Focus
        TPerl_FocusTarget
        TPerl_party1 (&2, 3, 4)
        TPerl_partypet1 (&2, 3, 4)

        Raid frames are defined by groups
        TPerl_Raid_Grp[1-9]
        You can query each raid group by doing
                TPerl_Raid_Grp1:GetAttribute("child1") for example
...
Still running through old code.
