...
TPerl_Author			= "|cFFFF8080TULOA|r"
TPerl_Description		= TPerl_ProductName.." by "..TPerl_Author
TPerl_VersionNumber		= C_AddOns.GetAddOnMetadata and C_AddOns.GetAddOnMetadata("TPerl", "Version")
TPerl_Version			= TPerl_Description.." - "..TPerl_VersionNumber
TPerl_LongDescription	= "UnitFrame replacement for new look Player, Pet, Party, Target, Target's Target, Focus, Raid"
TPerl_ModMenuIcon		= "Interface\\Icons\\INV_Misc_Gem_Pearl_02"

TPERL_MINIMAP_HELP1		= "|c00FFFFFFLeft click|r for Options (and to |c0000FF00unlock frames|r)"
TPERL_MINIMAP_HELP2		= "|c00FFFFFFRight click|r to drag this icon"
...
TPERL_MINIMAP_HELP5		= "|c00FFFFFFAlt|r for TPerl memory usage"
TPERL_MINIMAP_HELP6		= "|c00FFFFFF+Shift|r for TPerl memory usage since startup"

TPERL_MINIMENU_OPTIONS	= "Options"
TPERL_MINIMENU_ASSIST	= "Show Assists Frame"
TPERL_MINIMENU_CASTMON	= "Show Casting Monitor"
TPERL_MINIMENU_RAIDAD	= "Show Raid Admin"
TPERL_MINIMENU_ITEMCHK	= "Show Item Checker"
TPERL_MINIMENU_RAIDBUFF	= "Raid Buffs"
TPERL_MINIMENU_ROSTERTEXT="Roster Text"
TPERL_MINIMENU_RAIDSORT	= "Raid Sort"
TPERL_MINIMENU_RAIDSORT_GROUP = "Sort by Group"
TPERL_MINIMENU_RAIDSORT_CLASS = "Sort by Class"

TPERL_TYPE_NOT_SPECIFIED	= "Not specified"
TPERL_TYPE_PET				= PET
TPERL_TYPE_BOSS				= "Boss"
TPERL_TYPE_RAREPLUS 		= "Rare+"
TPERL_TYPE_ELITE			= "Elite"
TPERL_TYPE_RARE				= "Rare"

-- Zones
TPERL_LOC_ZONE_ANTORUS				= "Antorus"
TPERL_LOC_ZONE_BARADIN_HOLD 		= "Baradin Hold"
TPERL_LOC_ZONE_BASTION_OF_TWILIGHT	= "Basion of Twilight"
TPERL_LOC_ZONE_BLACK_TEMPLE			= "Black Temple"
TPERL_LOC_ZONE_BLACKWING_DECENT		= "Blackwing Decent"
TPERL_LOC_ZONE_DRAGONSOUL			= "Dragonsoul"
TPERL_LOC_ZONE_EMERALD_NIGHTMARE	= "Emerald Nightmare"
TPERL_LOC_ZONE_EYE_OF_ETERNITY		= "The Eye of Eternity"
TPERL_LOC_ZONE_FIRELANDS			= "Firelands"
TPERL_LOC_ZONE_HYJAL_SUMMIT			= "Hyjal Summit"
TPERL_LOC_ZONE_ICECROWN_CITADEL		= "Icecrown Citadel"
TPERL_LOC_ZONE_KARAZHAN				= "Karazhan"
TPERL_LOC_ZONE_NAXXRAMAS			= "Naxxramas"
TPERL_LOC_ZONE_NIGHTHOLD			= "Nighthold"
...
TPERL_LOC_ZONE_THRONE_OF_FOUR_WINDS = "Throne of Four Winds"
TPERL_LOC_ZONE_TOMB_OF_SARGERAS		= "Tomb of Sargeras"
TPERL_LOC_ZONE_TRIAL_OF_THE_CRUSADER= "Trial of the Crusader"
TPERL_LOC_ZONE_TRIAL_OF_VALOR		= "Trial of Valor"
...
TPERL_LOC_GHOST 	= "Ghost"
TPERL_LOC_FEIGNDEATH	= "Feign Death"
TPERL_LOC_FEIGNDEATHSHORT	= "FD"
TPERL_LOC_OFFLINE	= PLAYER_OFFLINE	-- "Offline"
TPERL_LOC_RESURRECTED	= "Resurrected"
TPERL_LOC_SS_AVAILABLE	= "SS Available"
TPERL_LOC_UPDATING	= "Updating"
TPERL_LOC_ACCEPTEDRES	= "Accepted"		-- Res accepted
TPERL_RAID_GROUP	= "Group %d"
TPERL_RAID_GROUPSHORT	= "G%d"

TPERL_LOC_NONEWATCHED	= "none watched"

TPERL_LOC_STATUSTIP = "Status Highlights: " 	-- Tooltip explanation of status highlight on unit
...
BINDING_NAME_TPERL_TOGGLERAID = "Toggle Raid Windows"
BINDING_NAME_TPERL_TOGGLERAIDSORT = "Toggle Raid Sort by Class/Group"
BINDING_NAME_TPERL_TOGGLERAIDPETS = "Toggle Raid Pets"
BINDING_NAME_TPERL_TOGGLEOPTIONS = "Toggle Options Window"
BINDING_NAME_TPERL_TOGGLEBUFFTYPE = "Toggle Buffs/Debuffs/none"
BINDING_NAME_TPERL_TOGGLEBUFFCASTABLE = "Toggle Castable/Curable"
BINDING_NAME_TPERL_TEAMSPEAKMONITOR = "Teamspeak Monitor"
BINDING_NAME_TPERL_TOGGLERANGEFINDER = "Toggle Range Finder"

TPERL_KEY_NOTICE_RAID_BUFFANY = "All buffs/debuffs shown"
TPERL_KEY_NOTICE_RAID_BUFFCURECAST = "Only castable/curable buffs or debuffs shown"
TPERL_KEY_NOTICE_RAID_BUFFS = "Raid Buffs shown"
TPERL_KEY_NOTICE_RAID_DEBUFFS = "Raid Debuffs shown"
TPERL_KEY_NOTICE_RAID_NOBUFFS = "No raid buffs shown"

TPERL_DRAGHINT1		= "|c00FFFFFFClick|r to scale window"
TPERL_DRAGHINT2		= "|c00FFFFFFShift+Click|r to resize window"
...
TPERL_USAGE_MODULES	= "Modules: "
TPERL_USAGE_NEWVERSION	= "*Newer version"
TPERL_USAGE_AVAILABLE	= "%s |c00FFFFFF%s|r is available for download"
...
TPERL_CMD_HELP		= "|c00FFFF80Usage: |c00FFFFFF/zperl menu | lock | unlock | config list | config delete <realm> <name>"
TPERL_CANNOT_DELETE_CURRENT = "Cannot delete you current config"
TPERL_CONFIG_DELETED		= "Deleted config for %s/%s"
TPERL_CANNOT_FIND_DELETE_TARGET = "Cannot find config to delete (%s/%s)"
TPERL_CANNOT_DELETE_BADARGS = "Please give realm name and player name"
TPERL_CONFIG_LIST		= "Config List:"
TPERL_CONFIG_CURRENT		= " (Current)"

TPERL_RAID_TOOLTIP_WITHBUFF	= "With buff: (%s)"
TPERL_RAID_TOOLTIP_WITHOUTBUFF	= "Without buff: (%s)"
TPERL_RAID_TOOLTIP_BUFFEXPIRING	= "%s's %s expires in %s"	-- Name, buff name, time to expire

TPERL_NEW_VERSION_DETECTED = "New version detected:"
TPERL_DOWNLOAD_LATEST = "You can download the latest version from:"
TPERL_DOWNLOAD_LOCATION = "https://www.curseforge.com/wow/addons/zperl-unitframes-fanupdate"


-- Status highlight spells
if IsRetail then
	TPERL_HIGHLIGHT_SPELLS = {
		hotSpells  = {
